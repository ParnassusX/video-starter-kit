...
import { Scissors, Wand2, Loader2, Save, Undo, Redo, Play, Pause, SkipBack, SkipForward, Layers, Palette } from 'lucide-react';
...
const STYLE_MODELS = [
  { id: 'cinematic', name: 'Cinematic', description: 'Professional film-like appearance' },
  { id: 'anime', name: 'Anime', description: 'Japanese animation style' },
  { id: 'vintage', name: 'Vintage', description: '70s/80s retro film look' },
  { id: 'noir', name: 'Film Noir', description: 'Black and white dramatic contrast' },
  ...
  { id: 'custom', name: 'Custom Style', description: 'Upload reference image for style transfer' },
];
...
const VIDEO_EFFECTS = [
  ...
  { id: 'vignette', name: 'Vignette', description: 'Darken the edges of the frame' },
...
export function VideoEditor({ videoUrl, onSave }: VideoEditorProps) {
  ...
  const [detectedScenes, setDetectedScenes] = useState<{start: number, end: number, thumbnail: string}[]>([]);
          ...
          <TabsContent value="style" className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-muted-foreground">{Math.round(styleIntensity * 100)}%</span>
              </div>
              <Slider
                id="style-intensity"
                min={0}
            ...
            {selectedEffect !== 'none' && (
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">{Math.round(effectIntensity * 100)}%</span>
                </div>
                <Slider
                  id="effect-intensity"
                  min={0}
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="text-xs text-muted-foreground">Upscale video using AI super-resolution</span>
                </div>
                <Switch
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="text-xs text-muted-foreground">Reduce camera shake and jitter</span>
                </div>
                <Switch
                  id="stabilize-video"
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="text-xs text-muted-foreground">Clean up video and audio noise</span>
                </div>
                <Switch
                  id="remove-noise"
                  checked={removeNoise}
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="text-xs text-muted-foreground">Automatically balance colors and exposure</span>
                </div>
                <Switch
                  id="color-correction"
